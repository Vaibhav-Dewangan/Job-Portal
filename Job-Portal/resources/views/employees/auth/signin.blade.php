...
<div class="mx-auto login-form p-4 p-sm-0 pt-5 pt-lg-4">
    <div class="card shadow-lg border-0 rounded-4 p-4 " style="max-width: 400px; margin: auto;">
        ...
        <form id="signInForm" method="post" action="{{ route('login.process') }}">
            @csrf
            <div id="signIn" class="">
                <div class="mb-3">
                ...
                <div class="mb-3 d-flex justify-content-center d-md-none">
                    <a href="{{ route('register') }}" class="small text-primary">New User? Sign Up First</a>
                </div>
                <div class="d-flex justify-content-between align-items-center">
                    <button type="submit" class="btn btn-primary w-100 py-2">Login</button>
                </div>
                <div class="mt-3 d-flex justify-content-between">
                    <a href="{{ route('register') }}" class="text-decoration-none text-primary d-none d-md-block">New User? Sign Up First</a>
                    <a href="#" id="forgotBtn" class="text-decoration-none text-danger">Forgot Password?</a>
                </div>
            </div>
        </form>

        <form id="resetForm" class="d-none" method="post" action="{{ route('reset.password') }}">
            @csrf
            <div id="reset">
                <div class="mb-3">
                    <label for="email" class="form-label fw-semibold">Email Address</label>
