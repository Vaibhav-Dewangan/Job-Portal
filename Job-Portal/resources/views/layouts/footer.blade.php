    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-4 ">
                ...
                <a href="#" class="text-white footer-icon me-3"><i class="bi bi-facebook"></i></a>
                <a href="#" class="text-white footer-icon me-3"><i class="bi bi-twitter"></i></a>
                <a href="#" class="text-white footer-icon me-3"><i class="bi bi-instagram"></i></a>
